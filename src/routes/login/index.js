    ...
    <div className="loginWrap">
      <div className="formLogin">
        ...
        <div className="appName">
          <img alt={intl.get('App.name')} src={imgAppName} />
        </div>
          ...
          <FormItem>
            {getFieldDecorator('shouji', {
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('Login.login.account.error.required'),
                },
                {
                  pattern: /^[0-9]+$/,
                  message: intl.get('Login.login.account.error.pattern'),
                },
              ],
            })(<Input
              type="number"
          ...
          <FormItem>
            {getFieldDecorator('mima', {
              rules: [
                {
                  required: true,
                  message: intl.get('Login.login.mima.error.required'),
                },
              ],
            })(<Input
